...
namespace LMS.Tables.Migrations
{
    ...
    [Migration("20241022050413_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Tables.Table.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Tables.Table.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Tables.Table.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Tables.Table.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMS.Tables.Table.Book", b =>
                {
                    b.HasOne("LMS.Tables.Table.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("LMS.Tables.Table.Order", b =>
                {
                    b.HasOne("LMS.Tables.Table.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LMS.Tables.Table.User", "User")
                        .WithMany()
